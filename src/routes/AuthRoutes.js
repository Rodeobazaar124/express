...
exports.AuthRoutes.post("/register", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, user, jti, _b, accessToken, refreshToken, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, User_services_1.createUserByEmailAndPassword)({ email: email, password: password })];
            case 2:
                user = _c.sent();
                jti = (0, uuid_1.v4)();
...
exports.AuthRoutes.post("/login", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.AuthRoutes.post("/refreshToken", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, User_services_1.findUserById)(payload.userId)];
            case 2:
                user = _b.sent();
                if (!user) {
                    res.status(401);
