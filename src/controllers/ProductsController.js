...
var ProductValidation_1 = require("../validation/ProductValidation");
var product = database_1.db.product;
var name = "products";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, product.findMany()];
            case 1:
                results = _a.sent();
            ...
            case 2:
                ...
                if (valIds === null)
                    return [2 /*return*/];
                return [4 /*yield*/, product.findFirst({
                        where: {
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                valbody = (0, validation_1.validate)(ProductValidation_1.ProductBodyValidation, req.body, res);
                if (valbody === null) {
                    return [2 /*return*/];
                }
                return [4 /*yield*/, product.findFirst({
...
var update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var valbody, theProduct, newfile, filesize, ext, filename, newurl, allowedType, filename_fromdb, filepath, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (theProduct === null) {
                    return [2 /*return*/, res
                            .status(404)
                            .json({ error: "Product ID ".concat(req.params.id, " Does Not exist!") })];
                }
                // Validate files
                if (req.files == null)
                    return [2 /*return*/, res.status(400).json({
            ...
            case 2:
                // set the data
                _a.sent();
                filename_fromdb = theProduct.filename;
...
var remove = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedIds, theProduct, filename, filepath, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (theProduct === null) {
                    return [2 /*return*/, res
                            .status(404)
                            .json({ error: "Product with ID ".concat(req.params.id, " Not exist!") })];
                }
                return [4 /*yield*/, product.delete({ where: { id: parseInt(req.params.id) } })];
            case 2:
                _a.sent();
            ...
            case 4:
                res
                    .status(200)
                    .json({ message: "Product with ID ".concat(validatedIds, " Deleted Succesfully") });
                return [3 /*break*/, 6];
            case 5:
                e_4 = _a.sent();
                next(e_4);
